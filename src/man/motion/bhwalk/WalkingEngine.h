...
#ifdef ROBOT_V5
  DEFINES_PARAMETER(float, walkStepDuration, 535.f)
  DEFINES_PARAMETER(float, walkStepDurationAtFullSpeedX, 535.f)
#else
...
#ifdef ROBOT_V5
  DEFINES_PARAMETER(Vector3BH<>, walkLiftOffset, Vector3BH<>(0.f, 5.f, 22.f))
  DEFINES_PARAMETER(Vector3BH<>, walkLiftOffsetAtFullSpeedX, Vector3BH<>(0.f, 5.f, 22.f))
#else
