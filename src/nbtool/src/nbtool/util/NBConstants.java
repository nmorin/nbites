...
import nbtool.gui.logviews.images.ColorLearningView;
...
public class NBConstants {
	...
	private static Map<String, Class<? extends ViewParent>[]> setupPossible() {
		...
		map.put("YUVImage", new Class[]{ImageView.class, ZoomImageView.class, FrontEndView.class, CrossBright.class, ColorLearningView.class, LineView.class, BallView.class, DebugImageView.class});
